...
public class SwiftyStore: NSObject, SKPaymentTransactionObserver, SKProductsRequestDelegate {
    
    public var productIDs = [String]()
    public var products = [String : SKProduct]()
    public var canMakePayments = true
    weak var delegate: SwiftyStoreDelegate?
    
    init(with IDs: [String]) {
        super.init()
...
protocol SwiftyStoreDelegate: class {
